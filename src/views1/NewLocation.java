...
public class NewLocation extends javax.swing.JPanel {
    ...
    private final String[] locationName = {"House", "Hospital", "School", "University", "Church", "Mosque", "Restaurant", "SuperMarket", "Factory"};
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(quantityTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        }
        ...
        this.mainFrame.getCurrentCityPanel().getCurrentLocationListPanel().addNewRow(this.name, this.kindName, this.percentage, this.quantity);
