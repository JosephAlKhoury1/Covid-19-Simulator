...
import views1.city.dialog.NewLocationDialog;
...
public class LocationListPanel extends JPanel implements ListSelectionListener {
    ...
    public void addNewRow(String name, String kind, double per, int qua) {
        ...
        for (Model m : this.mainFrame.getListModel()) {
            LocationCategory lcNew = new LocationCategory(name, kind, per, qua, m.getCity());
            lcNew.setLocationProperties(null);
    ...
    private class AddListener implements ActionListener, DocumentListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (alreadyInList(newName)) {
                Toolkit.getDefaultToolkit().beep();
                nameToAddTxt.requestFocusInWindow();
                nameToAddTxt.selectAll();
                JOptionPane.showOptionDialog(mainFrame, Messages.addLocationNameExistError(), Messages.error(), JOptionPane.CLOSED_OPTION, JOptionPane.ERROR_MESSAGE, null, null, null);
                return;
            }
            if (newName.startsWith(" ")) {
                ...
                nameToAddTxt.requestFocusInWindow();
                nameToAddTxt.selectAll();
                JOptionPane.showOptionDialog(mainFrame, Messages.addLocationStartWithSpaceError(), Messages.error(), JOptionPane.CLOSED_OPTION, JOptionPane.ERROR_MESSAGE, null, null, null);
                return;
            }
            if (newName.equals("")) {
                Toolkit.getDefaultToolkit().beep();
                nameToAddTxt.requestFocusInWindow();
                nameToAddTxt.selectAll();
                JOptionPane.showOptionDialog(mainFrame, Messages.addLocationNameNullError(), Messages.error(), JOptionPane.CLOSED_OPTION, JOptionPane.ERROR_MESSAGE, null, null, null);
                return;
            }
    ...
    private class RemoveListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int reply = JOptionPane.showOptionDialog(mainFrame, Messages.deleteLocationMessage(name), Messages.deleteLocation(), JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE, null, null, null);
