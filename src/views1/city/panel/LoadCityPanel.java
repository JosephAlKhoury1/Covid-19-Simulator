...
public class LoadCityPanel extends javax.swing.JPanel {
    ...
    public LoadCityPanel(MainFrame frame, LoadCityDialog dialog) {
        ...
        for (Entry<Integer, String> e : map.entrySet()) {
            if (!e.getValue().equals(frame.getCurrentCity().getName())) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText(Messages.loadCityHelpMessage());
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        name = this.jComboBox1.getItemAt(this.jComboBox1.getSelectedIndex());
