...
public class LocationProperties extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel3.setPreferredSize(new java.awt.Dimension(692, 225));
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(688, 152));

        mondayPanel.setPreferredSize(new java.awt.Dimension(686, 155));
        ...
        jPanel6.setPreferredSize(new java.awt.Dimension(656, 225));
        ...
        jScrollPane3.setPreferredSize(new java.awt.Dimension(705, 152));

        tuesdayPanel.setPreferredSize(new java.awt.Dimension(703, 155));
        ...
        wednesdayPanel.setPreferredSize(new java.awt.Dimension(703, 155));
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .addComponent(jPanel11, javax.swing.GroupLayout.DEFAULT_SIZE, 705, Short.MAX_VALUE)
        ...
        thursdayPanel.setPreferredSize(new java.awt.Dimension(703, 155));
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addComponent(jPanel15, javax.swing.GroupLayout.DEFAULT_SIZE, 705, Short.MAX_VALUE)
        ...
        fridayPanel.setPreferredSize(new java.awt.Dimension(703, 155));
        ...
        jScrollPane7.setPreferredSize(new java.awt.Dimension(705, 152));

        saturdayPanel.setPreferredSize(new java.awt.Dimension(703, 155));
        ...
        jScrollPane8.setPreferredSize(new java.awt.Dimension(705, 152));

        sundayPanel.setPreferredSize(new java.awt.Dimension(703, 155));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jPanel13, javax.swing.GroupLayout.DEFAULT_SIZE, 709, Short.MAX_VALUE)
            .addComponent(jPanel12, javax.swing.GroupLayout.DEFAULT_SIZE, 709, Short.MAX_VALUE)
    ...
    private void mondayBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mondayBoxActionPerformed
        ...
        if (cb.isSelected()) {
            ...
            this.locationCategory.getCity().getWeek().getMONDAY().getListLocationCategory().put(this.locationCategory.getName(), locationCategory);
            this.setMondayPanelEnable(true);
        } else {
            ...
            this.locationCategory.getCity().getWeek().getMONDAY().getListLocationCategory().remove(this.locationCategory.getName(), locationCategory);
            this.setMondayPanelEnable(false);
        }
        this.locationCategory.getMondayRow().setSaved(false);
        this.locationCategory.getCity().setIsSaved(false);
    ...
    private void tuesdayBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tuesdayBoxActionPerformed
        ...
        if (cb.isSelected()) {
            ...
            this.setTuesdayPanelEnable(true);
            this.locationCategory.getCity().getWeek().getTUESDAY().getListLocationCategory().put(this.locationCategory.getName(), locationCategory);
        } else {
            ...
            this.setTuesdayPanelEnable(false);
            this.locationCategory.getCity().getWeek().getTUESDAY().getListLocationCategory().remove(this.locationCategory.getName(), locationCategory);
        }
        this.locationCategory.getTuesdayRow().setSaved(false);
        this.locationCategory.getCity().setIsSaved(false);
        this.locationCategory.getCity().getMainFrame().setCitySavedButtonEnable();
    ...
    private void wednesdayBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wednesdayBoxActionPerformed
        ...
        if (cb.isSelected()) {
            ...
            this.setWednesdayPanelEnable(true);
            this.locationCategory.getCity().getWeek().getWEDNESDAY().getListLocationCategory().put(this.locationCategory.getName(), locationCategory);
        } else {
            ...
            this.setWednesdayPanelEnable(false);
            this.locationCategory.getCity().getWeek().getWEDNESDAY().getListLocationCategory().remove(this.locationCategory.getName(), locationCategory);
        }
        this.locationCategory.getWednesdayRow().setSaved(false);
        this.locationCategory.getCity().setIsSaved(false);
        this.locationCategory.getCity().getMainFrame().setCitySavedButtonEnable();
    ...
    private void thursdayBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_thursdayBoxActionPerformed
        ...
        if (cb.isSelected()) {
            ...
            this.setThursdayPanelEnable(true);
            this.locationCategory.getCity().getWeek().getTHURSDAY().getListLocationCategory().put(this.locationCategory.getName(), locationCategory);
        } else {
            ...
            this.setThursdayPanelEnable(false);
            this.locationCategory.getCity().getWeek().getTHURSDAY().getListLocationCategory().remove(this.locationCategory.getName(), locationCategory);
        }
        this.locationCategory.getThursdayRow().setSaved(false);
        this.locationCategory.getCity().setIsSaved(false);
        this.locationCategory.getCity().getMainFrame().setCitySavedButtonEnable();
    ...
    private void fridayBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fridayBoxActionPerformed
        ...
        if (cb.isSelected()) {
            ...
            this.setFridayPanelEnable(true);
            this.locationCategory.getCity().getWeek().getFRIDAY().getListLocationCategory().put(this.locationCategory.getName(), locationCategory);
        } else {
            ...
            this.setFridayPanelEnable(false);
            this.locationCategory.getCity().getWeek().getFRIDAY().getListLocationCategory().remove(this.locationCategory.getName(), locationCategory);
        }
        this.locationCategory.getFridayRow().setSaved(false);
        this.locationCategory.getCity().setIsSaved(false);
        this.locationCategory.getCity().getMainFrame().setCitySavedButtonEnable();
    ...
    private void saturdayBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saturdayBoxActionPerformed
        ...
        if (cb.isSelected()) {
            ...
            this.setSaturdayPanelEnable(true);
            this.locationCategory.getCity().getWeek().getSATURDAY().getListLocationCategory().put(this.locationCategory.getName(), locationCategory);
        } else {
            ...
            this.setSaturdayPanelEnable(false);
            this.locationCategory.getCity().getWeek().getSATURDAY().getListLocationCategory().remove(this.locationCategory.getName(), locationCategory);
        }
        this.locationCategory.getSatursayRow().setSaved(false);
        this.locationCategory.getCity().setIsSaved(false);
        this.locationCategory.getCity().getMainFrame().setCitySavedButtonEnable();
    ...
    private void sundayBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sundayBoxActionPerformed
        ...
        if (cb.isSelected()) {
            ...
            this.setSundayPanelEnable(true);
            this.locationCategory.getCity().getWeek().getSUNDAY().getListLocationCategory().put(this.locationCategory.getName(), locationCategory);
        ...
        this.locationCategory.getSundayRow().setSaved(false);
        this.locationCategory.getCity().setIsSaved(false);
        this.locationCategory.getCity().getMainFrame().setCitySavedButtonEnable();
