...
public class LoadModelPanel extends javax.swing.JPanel {

    public MainFrame frame;
    public LoadModelDialog dialog;
    Map<Integer, String> list;
    int id;

    public LoadModelPanel(MainFrame frame, LoadModelDialog dialog) {
        this.frame = frame;
        this.dialog = dialog;
        list = ModelController.INSTANCE.selectAll();
        initComponents();
        if (list.size() == frame.getListModel().size()) {
            ...
            for (Entry<Integer, String> e : list.entrySet()) {
                ...
                for (Model m : frame.getListModel()) {
                    if (m.getModelName().equals(e.getValue())) {
                        exist = true;
                    }
                }
                if (!exist) {
    ...
    private void initComponents() {
        ...
        warningLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icon/warning icon.jpg"))); // NOI18N
        warningLabel.setText(Messages.getNoModelToBeLoadedWarningMessage());
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icon/help icon.jpg"))); // NOI18N
        jLabel2.setToolTipText("");

        jLabel3.setText(Messages.getLoadModelHelpMessage());
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        String s = this.jComboBox1.getItemAt(this.jComboBox1.getSelectedIndex());
