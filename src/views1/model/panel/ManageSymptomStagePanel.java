...
public class ManageSymptomStagePanel extends javax.swing.JPanel implements ListSelectionListener {

    private MainFrame frame;
    private ManageSymptomStageDialog dialog;
    private String newName;
    private List<SymptomStageName> listSymptomNames;

    private JList<String> listSymptoms;
    private final DefaultListModel<String> listModel;

    private List<SymptomStageName> listAdded;
    private List<SymptomStageName> listRemoved;

    public ManageSymptomStagePanel(MainFrame frame, ManageSymptomStageDialog dialog) {
        initComponents();
        this.frame = frame;
        this.dialog = dialog;
        this.listAdded = new ArrayList();
        this.listRemoved = new ArrayList();
        listSymptomNames = frame.getListSymptomStageNames();
        ...
        for (SymptomStageName sn : listSymptomNames) {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        for (SymptomStageName sn : listAdded) {
            frame.getListSymptomStageNames().add(sn);
            sn.setId(SymptomStageNameController.INSTANCE.insert(sn));
        }
        for (SymptomStageName sn : listRemoved) {
            frame.getListSymptomStageNames().remove(sn);
            SymptomStageNameController.INSTANCE.delete(sn.getId());
        }
    ...
    private class RemoveListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            SymptomStageName removedSym = null;
            for (SymptomStageName sn : listSymptomNames) {
                if (sn.getName().equals(name)) {
                    removedSym = sn;
                    break;
