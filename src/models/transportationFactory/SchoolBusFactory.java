...
import models.transportation.SchoolBus;
 ...
 * @author Joseph
 */
public class SchoolBusFactory extends TransportationFactory {
    ...
    protected Transportation createTransportation(int id, int x, int y, int width, int height, double averageSick, int numberMember) throws RemoteException {
        return new SchoolBus(id, x, y, width, height, averageSick, numberMember);
    }
