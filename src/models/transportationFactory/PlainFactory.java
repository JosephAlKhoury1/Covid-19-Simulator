...
import models.transportation.Plain;
 ...
 * @author Joseph
 */
public class PlainFactory extends TransportationFactory {
    ...
    protected Transportation createTransportation(int id, int x, int y, int width, int height, double averageSick, int numberMember) throws RemoteException {
        return new Plain(id, x, y, width, height, averageSick, numberMember);
    }
